...
- **No Weight Penalties**:
  - Monks can wear/carry **any gear** without **AC penalties**.
...
- **Custom Monk Epic 1.0** available once **Kunark** is released.
...
Monk disciplines are activated buffs and abilities that consume **endurance** rather than mana. They can be acquired via **Tomes** purchased from class merchants in **East Commonlands Tunnel** and **Plane of Knowledge**.

| Discipline                  | Effect                                                         |
|----------------------------|----------------------------------------------------------------|
| **Stone Strike**           | Strike your target with a thrown stone, dealing minor damage.  |
| **Focused Healing**        | Channels energy to heal wounds; breaks on aggressive action.   |
...
| **Advanced Distracting Illusion** | Confuses the target, distracting them. (Up to Level 58)|
| **Earth Strength**         | Reduces melee damage taken.                                    |
| **Flying Kick Mastery**    | Enhances **Flying Kick** damage.                               |
| **Perfect Riposte**        | Temporarily ripostes all melee attacks.                        |
...
| **Greater Distracting Illusion** | Confuses the target. (Up to Level 61)                   |
...
| **Ultimate Distracting Illusion** | Confuses the target. (Up to Level 65)                  |
...
## Monk Spells and Abilities Page

Looking for more details on each Monk spell or ability? Visit:

[Monk Spells and Abilities](/classes-and-abilities/spells-and-abilities/mnk)
